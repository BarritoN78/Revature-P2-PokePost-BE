...
public class PokeCommServiceTests implements PokeCommInterface {
	...
	public PokeCommServiceTests(PokeCommRepository PokeCommRepo, RatePokeCommRepository ratePokeCommRepo,
